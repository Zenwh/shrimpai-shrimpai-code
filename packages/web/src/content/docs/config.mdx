...
The server/runtime config schema is defined in [**`shrimpai.cc/code/config.json`**](https://shrimpai.cc/code/config.json).

TUI config uses [**`shrimpai.cc/code/tui.json`**](https://shrimpai.cc/code/tui.json).
