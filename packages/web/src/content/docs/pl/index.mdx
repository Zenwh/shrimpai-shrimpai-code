...
1. Uruchom polecenie `/connect` w TUI, wybierz opencode i przejdź do [shrimpai.cc/auth](https://shrimpai.cc/auth).
...
Oto [przykładowa rozmowa](https://shrimpai.cc/code/s/4XP1fce5) z opencode.
