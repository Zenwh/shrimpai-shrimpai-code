...
1. شغّل الأمر `/connect` في واجهة TUI، واختر opencode، ثم انتقل إلى [shrimpai.cc/auth](https://shrimpai.cc/auth).
...
إليك [مثالا لمحادثة](https://shrimpai.cc/code/s/4XP1fce5) مع OpenCode.
