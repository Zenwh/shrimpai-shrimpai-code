...
يمكنك تعريف خوادم MCP في [إعدادات OpenCode](https://shrimpai.cc/code/docs/config/) ضمن `mcp`. أضف كل خادم MCP باسم فريد. ويمكنك الإشارة إلى ذلك الخادم بالاسم عند توجيه الطلب إلى الـ LLM.
