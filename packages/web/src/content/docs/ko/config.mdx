...
server/runtime config schema는 [**`shrimpai.cc/code/config.json`**](https://shrimpai.cc/code/config.json)에 정의되어 있습니다.

TUI config는 [**`shrimpai.cc/code/tui.json`**](https://shrimpai.cc/code/tui.json)을 사용합니다.
