...
1. Run the `/connect` command in the TUI, select opencode, and head to [shrimpai.cc/auth](https://shrimpai.cc/auth).
...
Here's an [example conversation](https://shrimpai.cc/code/s/4XP1fce5) with OpenCode.
