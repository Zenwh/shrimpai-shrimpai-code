...
1. 在 TUI 中執行 `/connect` 指令，選擇 `OpenCode Zen`，然後前往 [shrimpai.cc/auth](https://shrimpai.cc/auth)。
...
1. 在 TUI 中執行 `/connect` 指令，選擇 `OpenCode Go`，然後前往 [shrimpai.cc/auth](https://shrimpai.cc/auth)。
