...
Файл конфигурации имеет схему, определенную в [**`shrimpai.cc/code/config.json`**](https://shrimpai.cc/code/config.json).

Конфигурация TUI использует [**`shrimpai.cc/code/tui.json`**](https://shrimpai.cc/code/tui.json).
