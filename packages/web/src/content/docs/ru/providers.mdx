...
1. Запустите команду `/connect` в TUI, выберите `OpenCode Zen` и перейдите по адресу [shrimpai.cc/auth](https://shrimpai.cc/auth).
...
1. Запустите команду `/connect` в TUI, выберите `OpenCode Go` и перейдите по адресу [shrimpai.cc/auth](https://shrimpai.cc/auth).
