...
1. Запустите команду `/connect` в TUI, выберите opencode и перейдите по адресу [shrimpai.cc/auth](https://shrimpai.cc/auth).
...
Вот [пример диалога](https://shrimpai.cc/code/s/4XP1fce5) с opencode.
