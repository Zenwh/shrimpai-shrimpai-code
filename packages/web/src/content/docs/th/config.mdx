...
ไฟล์กำหนดค่ามีสคีมาที่กำหนดไว้ใน [**`shrimpai.cc/code/config.json`**](https://shrimpai.cc/code/config.json)

การกำหนดค่า TUI ใช้ [**`shrimpai.cc/code/tui.json`**](https://shrimpai.cc/code/tui.json)
