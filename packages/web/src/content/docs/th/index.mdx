...
1. เรียกใช้คำสั่ง `/connect` ใน TUI เลือก opencode และไปที่ [shrimpai.cc/auth](https://shrimpai.cc/auth)
...
นี่คือ [ตัวอย่างการสนทนา](https://shrimpai.cc/code/s/4XP1fce5) กับ OpenCode
