...
Konfiguracijski fajl ima šemu koja je definirana u [**`shrimpai.cc/code/config.json`**](https://shrimpai.cc/code/config.json).

TUI konfiguracija koristi [**`shrimpai.cc/code/tui.json`**](https://shrimpai.cc/code/tui.json).
