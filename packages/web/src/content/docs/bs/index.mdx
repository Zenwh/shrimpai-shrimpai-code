...
1. Pokrenite naredbu `/connect` u TUI-u, odaberite opencode i idite na [shrimpai.cc/auth](https://shrimpai.cc/auth).
...
:::
Evo [primjer razgovora](https://shrimpai.cc/code/s/4XP1fce5) sa OpenCode.
