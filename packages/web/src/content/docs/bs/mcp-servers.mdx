...
Možete definirati MCP servere u vašoj [OpenCode Config](https://shrimpai.cc/code/docs/config/) pod `mcp`. Dodajte svaki MCP sa jedinstvenim imenom. Možete se pozvati na taj MCP po imenu kada tražite LLM.
