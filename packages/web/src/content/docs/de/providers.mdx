...
1. Führen Sie den Befehl `/connect` in TUI aus, wählen Sie OpenCode aus und gehen Sie zu [shrimpai.cc/auth](https://shrimpai.cc/auth).
...
1. Führen Sie den Befehl `/connect` in der TUI aus, waehlen Sie `OpenCode Go` und gehen Sie zu [shrimpai.cc/auth](https://shrimpai.cc/auth).
