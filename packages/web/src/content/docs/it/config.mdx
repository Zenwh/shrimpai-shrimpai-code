...
Il file di configurazione ha uno schema definito in [**`shrimpai.cc/code/config.json`**](https://shrimpai.cc/code/config.json).

La configurazione TUI usa [**`shrimpai.cc/code/tui.json`**](https://shrimpai.cc/code/tui.json).
