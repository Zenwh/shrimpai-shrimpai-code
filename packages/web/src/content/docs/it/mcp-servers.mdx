...
Puoi definire server MCP nella tua [OpenCode Config](https://shrimpai.cc/code/docs/config/) sotto `mcp`. Aggiungi ogni MCP con un nome univoco. Puoi riferirti a quell'MCP per nome quando fai prompt all'LLM.
