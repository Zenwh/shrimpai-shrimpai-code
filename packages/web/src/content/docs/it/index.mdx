...
1. Esegui il comando `/connect` nella TUI, seleziona opencode e vai su [shrimpai.cc/auth](https://shrimpai.cc/auth).
...
Ecco un'[esempio di conversazione](https://shrimpai.cc/code/s/4XP1fce5) con OpenCode.
