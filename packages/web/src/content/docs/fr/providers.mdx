...
1. Exécutez la commande `/connect` dans le TUI, sélectionnez opencode et dirigez-vous vers [shrimpai.cc/auth](https://shrimpai.cc/auth).
...
1. Exécutez la commande `/connect` dans le TUI, sélectionnez `OpenCode Go` et rendez-vous sur [shrimpai.cc/auth](https://shrimpai.cc/auth).
