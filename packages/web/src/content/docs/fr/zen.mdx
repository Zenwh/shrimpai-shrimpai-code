...
| ---------------------- | ---------------------- | -------------------------------------------------- | --------------------------- |
| GPT 5.5                | gpt-5.5                | `https://shrimpai.cc/auth/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.5 Pro            | gpt-5.5-pro            | `https://shrimpai.cc/auth/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.4                | gpt-5.4                | `https://shrimpai.cc/auth/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.4 Pro            | gpt-5.4-pro            | `https://shrimpai.cc/auth/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.4 Mini           | gpt-5.4-mini           | `https://shrimpai.cc/auth/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.4 Nano           | gpt-5.4-nano           | `https://shrimpai.cc/auth/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.3 Codex          | gpt-5.3-codex          | `https://shrimpai.cc/auth/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.3 Codex Spark    | gpt-5.3-codex-spark    | `https://shrimpai.cc/auth/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.2                | gpt-5.2                | `https://shrimpai.cc/auth/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.2 Codex          | gpt-5.2-codex          | `https://shrimpai.cc/auth/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.1                | gpt-5.1                | `https://shrimpai.cc/auth/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.1 Codex          | gpt-5.1-codex          | `https://shrimpai.cc/auth/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.1 Codex Max      | gpt-5.1-codex-max      | `https://shrimpai.cc/auth/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.1 Codex Mini     | gpt-5.1-codex-mini     | `https://shrimpai.cc/auth/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5                  | gpt-5                  | `https://shrimpai.cc/auth/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5 Codex            | gpt-5-codex            | `https://shrimpai.cc/auth/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5 Nano             | gpt-5-nano             | `https://shrimpai.cc/auth/v1/responses`             | `@ai-sdk/openai`            |
| Claude Opus 4.7        | claude-opus-4-7        | `https://shrimpai.cc/auth/v1/messages`              | `@ai-sdk/anthropic`         |
| Claude Opus 4.6        | claude-opus-4-6        | `https://shrimpai.cc/auth/v1/messages`              | `@ai-sdk/anthropic`         |
| Claude Opus 4.5        | claude-opus-4-5        | `https://shrimpai.cc/auth/v1/messages`              | `@ai-sdk/anthropic`         |
| Claude Opus 4.1        | claude-opus-4-1        | `https://shrimpai.cc/auth/v1/messages`              | `@ai-sdk/anthropic`         |
| Claude Sonnet 4.6      | claude-sonnet-4-6      | `https://shrimpai.cc/auth/v1/messages`              | `@ai-sdk/anthropic`         |
| Claude Sonnet 4.5      | claude-sonnet-4-5      | `https://shrimpai.cc/auth/v1/messages`              | `@ai-sdk/anthropic`         |
| Claude Sonnet 4        | claude-sonnet-4        | `https://shrimpai.cc/auth/v1/messages`              | `@ai-sdk/anthropic`         |
| Claude Haiku 4.5       | claude-haiku-4-5       | `https://shrimpai.cc/auth/v1/messages`              | `@ai-sdk/anthropic`         |
| Claude Haiku 3.5       | claude-3-5-haiku       | `https://shrimpai.cc/auth/v1/messages`              | `@ai-sdk/anthropic`         |
| Gemini 3.1 Pro         | gemini-3.1-pro         | `https://shrimpai.cc/auth/v1/models/gemini-3.1-pro` | `@ai-sdk/google`            |
| Gemini 3 Flash         | gemini-3-flash         | `https://shrimpai.cc/auth/v1/models/gemini-3-flash` | `@ai-sdk/google`            |
| Qwen3.6 Plus           | qwen3.6-plus           | `https://shrimpai.cc/auth/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Qwen3.5 Plus           | qwen3.5-plus           | `https://shrimpai.cc/auth/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| MiniMax M2.5           | minimax-m2.5           | `https://shrimpai.cc/auth/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| MiniMax M2.5 Free      | minimax-m2.5-free      | `https://shrimpai.cc/auth/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| MiniMax M2.7           | minimax-m2.7           | `https://shrimpai.cc/auth/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| GLM 5.1                | glm-5.1                | `https://shrimpai.cc/auth/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| GLM 5                  | glm-5                  | `https://shrimpai.cc/auth/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Kimi K2.5              | kimi-k2.5              | `https://shrimpai.cc/auth/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Kimi K2.6              | kimi-k2.6              | `https://shrimpai.cc/auth/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Big Pickle             | big-pickle             | `https://shrimpai.cc/auth/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| DeepSeek V4 Flash Free | deepseek-v4-flash-free | `https://shrimpai.cc/auth/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Ring 2.6 1T            | ring-2.6-1t-free       | `https://shrimpai.cc/auth/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Nemotron 3 Super Free  | nemotron-3-super-free  | `https://shrimpai.cc/auth/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
...
```
https://shrimpai.cc/auth/v1/models
```
...
- Ring 2.6 1T Free est disponible sur OpenCode pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
