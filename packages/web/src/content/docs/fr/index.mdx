...
1. Exécutez la commande `/connect` dans le TUI, sélectionnez opencode et allez sur [shrimpai.cc/auth](https://shrimpai.cc/auth).
...
Voici un [exemple de conversation](https://shrimpai.cc/code/s/4XP1fce5) avec OpenCode.
