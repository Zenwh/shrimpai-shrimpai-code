...
Le fichier de configuration a un schéma défini dans [**`shrimpai.cc/code/config.json`**](https://shrimpai.cc/code/config.json).

La configuration TUI utilise [**`shrimpai.cc/code/tui.json`**](https://shrimpai.cc/code/tui.json).
