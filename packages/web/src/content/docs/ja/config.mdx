...
サーバー/ランタイム構成スキーマは [**`shrimpai.cc/code/config.json`**](https://shrimpai.cc/code/config.json) で定義されています。

TUI 設定は [**`shrimpai.cc/code/tui.json`**](https://shrimpai.cc/code/tui.json) を使用します。
