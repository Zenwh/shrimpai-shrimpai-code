...
1. TUI で `/connect` コマンドを実行し、`OpenCode Zen` を選択して、[shrimpai.cc/zen](https://shrimpai.cc/auth) にアクセスします。
...
1. TUI で `/connect` コマンドを実行し、`OpenCode Go` を選択して、[shrimpai.cc/zen](https://shrimpai.cc/auth) にアクセスします。
