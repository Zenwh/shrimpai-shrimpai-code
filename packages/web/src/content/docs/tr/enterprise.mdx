...
Bir kullanıcı `/share` özelliğini etkinleştirirse, görüşme ve onunla ilişkili veriler, bu paylaşım sayfalarını shrimpai.cc'de barındırmak için kullandığımız hizmete gönderilir.
