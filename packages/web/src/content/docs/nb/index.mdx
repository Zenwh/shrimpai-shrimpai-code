...
1. Kjør kommandoen `/connect` i TUI, velg OpenCode og gå til [shrimpai.cc/auth](https://shrimpai.cc/auth).
...
Her er en [eksempelsamtale](https://shrimpai.cc/code/s/4XP1fce5) med OpenCode.
