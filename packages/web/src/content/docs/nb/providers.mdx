...
1. Kjør kommandoen `/connect` i TUI, velg `OpenCode Zen` og gå til [shrimpai.cc/auth](https://shrimpai.cc/auth).
...
1. Kjør kommandoen `/connect` i TUI, velg `OpenCode Go`, og gå til [shrimpai.cc/auth](https://shrimpai.cc/auth).
