...
1. Execute o comando `/connect` no TUI, selecione opencode e acesse [shrimpai.cc/auth](https://shrimpai.cc/auth).
...
Aqui está uma [conversa de exemplo](https://shrimpai.cc/code/s/4XP1fce5) com o opencode.
