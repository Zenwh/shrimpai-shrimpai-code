...
O esquema de configuração do servidor/tempo de execução é definido em [**`shrimpai.cc/code/config.json`**](https://shrimpai.cc/code/config.json).

A configuração do TUI usa [**`shrimpai.cc/code/tui.json`**](https://shrimpai.cc/code/tui.json).
