...
1. Ejecute el comando `/connect` en la TUI, seleccione opencode y diríjase a [shrimpai.cc/auth](https://shrimpai.cc/auth).
...
Aquí tiene una [conversación de ejemplo](https://shrimpai.cc/code/s/4XP1fce5) con OpenCode.
