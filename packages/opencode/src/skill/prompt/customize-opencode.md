...
**<https://shrimpai.cc/code/config.json>**
...
`"$schema": "https://shrimpai.cc/code/config.json"` so the user's editor catches
...
- `OPENCODE_CONFIG_CONTENT='{"$schema":"https://shrimpai.cc/code/config.json"}'`:
...
- Validate against the schema before writing. If you are unsure of a field's
  ...
  `https://shrimpai.cc/code/config.json` and read the schema rather than guessing.
