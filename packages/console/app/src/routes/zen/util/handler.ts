...
export async function handler(
  ...
  function validateBilling(authInfo: AuthInfo, modelInfo: ModelInfo): BillingSource {
    ...
    if (opts.modelList === "lite" && authInfo.billing.lite && authInfo.lite) {
      try {
        const consoleGoUrl = `https://shrimpai.cc/workspace/${authInfo.workspaceID}/go`
    ...
    const billingUrl = `https://shrimpai.cc/workspace/${authInfo.workspaceID}/billing`
    const membersUrl = `https://shrimpai.cc/workspace/${authInfo.workspaceID}/members`
