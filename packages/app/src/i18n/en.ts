export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Shrimpai Code",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Shrimpai Code.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "Shrimpai Code Pro gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.opencodeZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.opencodeZen.visit.prefix": "Visit ",
  "provider.connect.opencodeZen.visit.link": "shrimpai.cc/auth",
  "provider.connect.opencodeZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Shrimpai Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Shrimpai Code.",
  ...
  "provider.custom.error.detect.required": "Detect models first",
  "provider.custom.error.detect.noneSelected": "Select at least one model",
  ...
  "dialog.server.description": "Switch which Shrimpai Code server this app connects to.",
  ...
  "toast.update.description": "A new version of Shrimpai Code ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Shrimpai Code team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Shrimpai Code does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Shrimpai Code includes free models so you can start immediately.",
  ...
  "app.name.desktop": "Shrimpai Code Desktop",
  ...
  "settings.desktop.wsl.description": "Run the Shrimpai Code server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Shrimpai Code",
  ...
  "settings.general.row.appearance.description": "Customise how Shrimpai Code looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Shrimpai Code follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Shrimpai Code is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Shrimpai Code launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Shrimpai Code.",
