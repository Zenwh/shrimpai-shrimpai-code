...
function useShareUrl() {
  return isMock() ? "https://dev.shrimpai.cc/code" : "https://shrimpai.cc/code"
}
...
async function getAccessToken() {
  ...
  let response
  if (isMock()) {
    response = await fetch("https://api.shrimpai.cc/exchange_github_app_token_with_pat", {
      method: "POST",
      headers: {
    ...
    response = await fetch("https://api.shrimpai.cc/exchange_github_app_token", {
      method: "POST",
      headers: {
